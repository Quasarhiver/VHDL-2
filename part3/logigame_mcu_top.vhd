...
architecture Behavioral of Arty_Digilent_TopLevel is
    ...
    -- Couleur dérivée du LFSR MCU (RESOUT[3:0], plages égales)
...
begin
    ...
    -- =========================================================================
    -- Dérivation couleur depuis RESOUT[3:0] (cf. sujet, modulo 3) :
    --   rnd mod 3 = 0 → Rouge (100)
    --   rnd mod 3 = 1 → Vert  (010)
    --   rnd mod 3 = 2 → Bleu  (001)
    -- =========================================================================
    process(resout_s)
    begin
